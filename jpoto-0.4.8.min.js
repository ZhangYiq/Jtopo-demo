!function(window) {
	...
	CanvasRenderingContext2D.prototype.JTopoRoundRect = function(a, b, c, d, e) {
		...
		MouseCursor: {
			...
			move: "move",
			open_hand: "url(/WebContent/mainfrm/common/img/cur/openhand.cur) 8 8, default",
	...
	function b(isDrag,c) {
		...
		this.initialize = function() {
			...
			var c = this.toSceneEvent(b);
			if(isDrag == false){/*修改drag处理代码，设置不可拖动*/
			if(c.target == null)
				return;
			}
			this.mode == a.SceneMode.normal ? null == this.currentElement 
						|| this.currentElement instanceof a.Link ? 1 == this.translate && 
						(this.stage.cursor = a.MouseCursor.closed_hand, this.translateX = this.lastTranslateX + c.dx, this.translateY = this.lastTranslateY + c.dy)
						: this.dragElements(c) : this.mode == a.SceneMode.drag ? 1 == this.translate && 
						(this.stage.cursor = a.MouseCursor.closed_hand, this.translateX = this.lastTranslateX + c.dx, this.translateY = this.lastTranslateY + c.dy) 
						: this.mode == a.SceneMode.select ? null != this.currentElement ? 1 == this.currentElement.dragable && this.dragElements(c)
						: 1 == this.areaSelect && this.areaSelectHandle(c) : this.mode == a.SceneMode.edit && 
						(null == this.currentElement || this.currentElement instanceof a.Link ? 1 == this.translate && 
						(this.stage.cursor = a.MouseCursor.closed_hand, this.translateX = this.lastTranslateX + c.dx, this.translateY = this.lastTranslateY + c.dy) 
	...
	function b(c) {
		/*modify新增nodeInfo*/
		this.initialize = function(c,nodeInfo) {
			b.prototype.initialize.apply(this, arguments), this.elementType = "node", this.zIndex = a.zIndex_Node, this.text = c,this.nodeInfo = nodeInfo,  this.font = "12px Consolas", this.fontColor = "255,255,255", this.borderWidth = 0, this.borderColor = "255,255,255", this.borderRadius = null, this.dragable = !0, this.textPosition = "Bottom_Center", this.textOffsetX = 0, this.textOffsetY = 0, this.transformAble = !0, this.inLinks = null, this.outLinks = null;
			...
			/*modify绘制节点信息的函数*/
			if(this.showNodeInfo != null && this.showNodeInfo.newType == null){
				var b = "0,0,0",
				c = .5;
			a.beginPath(), a.font = this.alarmFont || "10px 寰蒋闆呴粦";
			var d = a.measureText(this.showNodeInfo.ip).width + 50,
				e = a.measureText("鐢�").width + 45,
				f = this.width / 2 - d / 2,
				g = -this.height/2 - e - 8;
			var ipShow = "IP:"+this.showNodeInfo.ip;
			var cpuShow = "CPU:"+this.showNodeInfo.cpu;
			var storageShow = "STORAGE:"+this.showNodeInfo.storage;
			var ramShow = "RAM:"+this.showNodeInfo.ram;
			...
			a.fillText(ipShow, f + 2, g + e -52);
			a.fillText(cpuShow, f + 2, g + e -36);
			a.fillText(storageShow, f + 2, g + e -20);
			a.fillText(ramShow, f + 2, g + e - 4);
			a.closePath();
			}
